...
// The displayed glyph is the actual BQN expression so the player learns
// the real syntax (⊸ for left-bind, ⟜ for right-bind, etc.).
const make = (expr: string): Rune => ({ glyph: expr, expr });
const R = {
	add1: make('+⟜1'),
	add2: make('+⟜2'),
	add3: make('+⟜3'),
