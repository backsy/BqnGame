...
//
// Visually this fuses filter (predicate-badge-flip) and sizing (height +
// label tween):
//   Phase 1: a predicate badge (e.g. ">2") appears above each cell.
...
//            colour transitions if a sign change occurs.
